...
// Modify the showOrderForm function to handle both cart items and direct "Buy Now" items
...
// Update the openOrderForm function to handle both cart items and direct orders
